...
;(function ($) {
    ...
    $.fn.waterwheelCarousel.defaults = {
        ...
        horizonOffsetMultiplier:    3,   // multipled by horizon offset to increase/decrease offset for each additional item
...
jQuery(document).ready(function() {
    ...
    //}
/*    if (windowWidth > 990) {
        var carousel2 = jQuery('.carousel').waterwheelCarousel({
            sizeMultiplier: 0.5,
            separation:                 45,
